...
var PlayerControlService = (function () {
    function PlayerControlService(gameStore, target) {
        this.gameStore = gameStore;
        this.target = target;
        this.keyDownSubscription = null;
    }
    PlayerControlService.prototype.start = function () {
        var _this = this;
    ...
    PlayerControlService.prototype.extractKeyCode = function (event) {
        return event.keyCode;
    };
    PlayerControlService.prototype.filterArrows = function (keyCode) {
        switch (keyCode) {
            case 38: // up
            case 87: // w
            case 40: // right
    ...
    PlayerControlService.prototype.keyCodeToAction = function (keyCode) {
        switch (keyCode) {
            case 38: // up
            case 87:
    ...
    PlayerControlService.prototype.stop = function () {
        if (this.keyDownSubscription) {
            this.keyDownSubscription.unsubscribe();
            this.keyDownSubscription = null;
        }
    };
    PlayerControlService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [game_store_1.GameStore, Window])
    ], PlayerControlService);
    return PlayerControlService;
}());
exports.PlayerControlService = PlayerControlService;
//# sourceMappingURL=player-control.service.js.map